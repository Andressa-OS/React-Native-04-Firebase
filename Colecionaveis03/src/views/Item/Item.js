    ...
    return (
        ...
        <View style={estiloItem.formularioContainer}>
            ...
            <View style={estiloItem.campoContainer}>
                <FontAwesome name="book" size={26} color="#FFD700" />
                <TextInput
            ...
            <View style={estiloItem.campoContainer}>
                <FontAwesome5 name="book-reader" size={26} color="#FFD700" />
                <TextInput
                style={estiloItem.campo}
                placeholder="Autor"
                placeholderTextColor="#FFFFFF"
            ...
            <View style={estiloItem.campoContainer}>
                <FontAwesome5 name="calendar-alt" size={26} color="#FFD700" />
                <TextInput
                style={estiloItem.campo}
           ...
           <View style={estiloItem.campoContainerDescricao}>
                <FontAwesome5 name="book-open" size={26} color="#FFD700" />
                <ScrollView style={estiloItem.campoDiscricaoScroll}>
                    <TextInput
